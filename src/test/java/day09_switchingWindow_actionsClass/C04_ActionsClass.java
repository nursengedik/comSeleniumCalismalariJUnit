...
public class C04_ActionsClass extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        actions.dragAndDrop(dragMeElementi,dropHereElementi).perform();//önce taşınacak element sonra hedef element yazılır
        ...
        String actualYazi = droppedYaziElementi.getText();//actual'ı webelement'ten alacağız
