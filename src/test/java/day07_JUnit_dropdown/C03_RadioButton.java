...
public class C03_RadioButton {
    ...
    public void radioButtonTest(){
        ...
        //	b. Cookies’i kabul edin
        //sadece locate (lokeyt) edeceğimiz için web elementi kaydetmemize gerek yok
        //driver.findElement(By.xpath("//button[@title='Allow all cookies']")).click();
        //facebook sayfasına gidince Cookies çıkmadığı için locate edemeyiz, yoruma aldım, almazsak hata verir
        ...
        Assert.assertTrue(maleButtonElementi.isSelected());//bunun seçili olduğu iddiasının doğru olmasını istiyoruz
