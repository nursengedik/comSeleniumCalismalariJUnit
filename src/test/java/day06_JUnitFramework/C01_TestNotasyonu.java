...
public class C01_TestNotasyonu {
     ...
     */
     ...
     /*
        ...
        bu durumda @Ignore (notasyonunu) kullanabilirsiniz

     */
     /*
       Bir class ta birden fazla test yapacaksak her testte ayrı ayrı 4 atlıyı oluşturmak
       yerine bir method oluşturup her testten bu methodu çağırırız,
       ama driver ı her testte kullanamayız çünkü o driver başka bir methodun içinde oluşturuldu
       bunun için Class Level de WebDriver driver; objesi oluşturulur, methodda da değer ataması yapılır
       driver=new ChromeDriver();
       bundan sonra driver ı her test içerisinde obje oluşturmadan kullanabiliriz
     */
    ...
    public void wiseTest(){
        ...
        if (actualUrl.contains(expectedIcerik)){
            ...
            System.out.println("Url wisequarter içermiyor, Wisequarter testi FAILED");
        }
        driver.close();
    ...
    public void amazonTest(){
        ...
        //logoyu test edebilmemiz için web elementi kaydetmemiz gerekir
        WebElement amazonLogoElementi=driver.findElement(By.id("nav-logo-sprites"));

        if (amazonLogoElementi.isDisplayed()){
            System.out.println("Amazon testi PASSED");
        }else {
            System.out.println("Amazon logosu görünmüyor, Amazon testi FAILED");
        }
        driver.close();
