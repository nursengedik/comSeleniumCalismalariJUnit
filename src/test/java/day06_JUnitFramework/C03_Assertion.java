...
public class C03_Assertion {//C01 deki testin Assert ile çözümü
    ...
    public void amazonTest(){
        //3- amazon anasayfaya gidip, amazon logosunun gorundugunu test edin (olumlu cümle)
